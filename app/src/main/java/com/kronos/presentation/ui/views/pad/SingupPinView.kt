package com.kronos.presentation.ui.views.pad
...
@Composable
fun SingUpPinView(navController: NavController, employeesLoginViewModel: EmployeesLoginViewModel) {
    Column(
    ) {
        ...
        Row(
            ...
            Box(
                ...
                Column(
                    ...
                    NumericPad(employeesLoginViewModel, navController)
                    //Spacer(modifier = Modifier.size(10.dp))
...
fun NumericPad(employeesLoginViewModel: EmployeesLoginViewModel, navController: NavController) {
    var pines by remember {  mutableStateOf<String>("") }  // Almacena el valor del PIN como Int

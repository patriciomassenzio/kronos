...
fun preview(){
    ...
    LoginView(Modifier.fillMaxSize(), NavController(context), LoginViewModel(context, NavHostController(context)))
}
...
fun LoginView(
    ...
    val typeUser: String by loginViewModel.typeUser.observeAsState("")

    LaunchedEffect(typeUser) {
        when (typeUser) {
